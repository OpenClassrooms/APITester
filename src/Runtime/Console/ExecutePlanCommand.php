...
use APITester\Test\Runner\ParaTest\ParaTestRunner;
...
final class ExecutePlanCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $planConfig = \APITester\Runtime\Config\Loader\PlanConfigLoader::load($configPath);
        $plan = new Plan();
    ...
    private function updateBaseline(\APITester\Runtime\Config\Entity\Suite $suiteConfig, string $junitFile): void
    {
