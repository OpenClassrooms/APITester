...
abstract class AbstractPhpUnitRunner implements TestRunner
{
    ...
    final public function createRunnerFile(
        ...
        $content = <<<'PHP'
            ...
            use APITester\Runtime\Config\Loader\PlanConfigLoader;use APITester\Test\Entity\Plan;use APITester\Test\Entity\TestCase;use Symfony\Component\Console\Logger\ConsoleLogger;use Symfony\Component\Console\Output\ConsoleOutput;use Symfony\Component\HttpKernel\HttpKernelInterface;
     ...
     * @return list<string>
     */
    private function buildArguments(array $options, \APITester\Runtime\Config\Entity\Suite $suiteConfig): array
    {
        $args = ['--colors=auto'];
