...
use APITester\Schema\Loader\Exception\DefinitionLoaderNotFoundException;
use APITester\Schema\Loader\Exception\DefinitionLoadingException;
use APITester\Test\Authenticator\Authenticator;
use APITester\Test\Authenticator\Exception\AuthenticationException;
use APITester\Test\Authenticator\Exception\AuthenticationLoadingException;
use APITester\Test\Exception\SuiteNotFoundException;
use APITester\Test\Preparator\Exception\InvalidPreparatorConfigException;
use APITester\Test\Preparator\Exception\PreparatorLoadingException;
use APITester\Test\Preparator\TestCasesPreparator;
...
final class Plan
{
        ...
        \APITester\Runtime\Config\Entity\Plan $testPlanConfig, string $suiteName = ''): \APITester\Runtime\Config\Entity\Suite
    {
        ...
        if ($suiteName !== '') {
            ...
            /** @var \APITester\Runtime\Config\Entity\Suite $suite */
    ...
    private function loadSymfonyKernel(\APITester\Runtime\Config\Entity\Suite $suiteConfig): ?Kernel
    {
        $kernel = null;
     ...
     * @throws DefinitionLoadingException
     */
    private function loadApiDefinition(\APITester\Runtime\Config\Entity\Suite $config, array $options = []): Api
    {
     ...
     */
    private function filterTestCases(\APITester\Runtime\Config\Entity\Suite $suiteConfig, iterable $tests): iterable
    {
     ...
     * @return iterable<array-key, TestCase>
     */
    private function filterOnlyTestCases(\APITester\Runtime\Config\Entity\Suite $suiteConfig, iterable $tests): iterable
    {
