...
namespace APITester\Test\Authenticator;

use APITester\Runtime\Config\Entity\Auth;
use APITester\Runtime\Requester\Requester;
use APITester\Schema\Entity\Api;
use APITester\Schema\Entity\Security;
use APITester\Schema\Entity\Security\OAuth2\OAuth2AuthorizationCodeSecurity;
use APITester\Schema\Entity\Security\OAuth2\OAuth2ClientCredentialsSecurity;
