 ...
 * deprecated use the one from symfony 5 after upgrade
 */
final class PhpStanExtractor implements PropertyTypeExtractorInterface
{
    ...
    {
        $tags = array_values(
            array_filter($docNode->getTagsByName('@param'), function ($tagNode) use ($allowedParam) {
